...
import project.domain.entity.cargo.Cargo;
import project.domain.entity.cargo.box.Box;
import project.domain.entity.cargo.oil.Oil;
import project.domain.entity.cargo.products.Product;
import project.domain.entity.clients.Client;
import project.domain.entity.employees.Employee;
import project.domain.entity.employees.drivers.Driver;
import project.domain.entity.employees.managers.Manager;
import project.domain.entity.organizations.Organization;
import project.domain.entity.truck.Truck;
import project.domain.entity.truck.refrigerated.Refrigerated;
import project.domain.entity.truck.tank.Tank;
import project.domain.entity.truck.tented.Tented;
